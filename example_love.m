...
stringArt( ...
    'inputFilePath', 'input/love.png', ... % path to the input file
    'outputDirPath', 'output/love', ... % path to the output directory
    'outputFileNamePrefix', 'love', ... % prefix of the output files
